...
exports.UniversalExtractor = void 0;
const openai_1 = require("openai");
const uuid_1 = require("uuid");
class UniversalExtractor {
    constructor(apiKey, baseUrl, model) {
        this.client = new openai_1.OpenAI({ apiKey, baseURL: baseUrl });
        this.model = model;
    }
    async extractToGraph(text, sourceId, publishDate, graph) {
        const prompt = `
    你是一个顶级的时序知识图谱构建专家。
    ...
    `;
        try {
            ...
            for (const t of tuples) {
                ...
                const tup = {
                    id: `tup_${(0, uuid_1.v4)().substring(0, 8)}`,
                    subject: t.S || '',
                    predicate: t.P || '',
                    object: String(t.O || ''),
                    time: dt,
...
exports.UniversalExtractor = UniversalExtractor;
